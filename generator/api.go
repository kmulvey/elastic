...
//go:generate go run builder.go -i=rest-api-spec/cat.tasks.json
...
//go:generate go run builder.go -i=rest-api-spec/cluster.allocation_explain.json
...
//go:generate go run builder.go -i=rest-api-spec/create.json
...
//go:generate go run builder.go -i=rest-api-spec/indices.rollover.json
...
//go:generate go run builder.go -i=rest-api-spec/indices.shrink.json
...
//go:generate go run builder.go -i=rest-api-spec/ingest.simulate.json
...
//go:generate go run builder.go -i=rest-api-spec/msearch_template.json
...
//go:generate go run builder.go -i=rest-api-spec/reindex_rethrottle.json
...
//go:generate go run builder.go -i=rest-api-spec/tasks.get.json
